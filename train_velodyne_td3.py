...
eval_ep = 10  # number ofepisodes for evaluation
max_timesteps = 1e6  # Maximum number of steps to perform
expl_noise = 0.8  # Initial exploration noise starting value in range [expl_min ... 1]
expl_decay_steps = (
    2000000  # Number of steps over which the initial exploration noise will decay over
)
expl_min = 0.3  # Exploration noise after the decay in range [0...expl_noise]
batch_size = 256  # Size of the mini-batch
discount = 0.98  # Discount factor to calculate the discounted future reward (should be close to 1)
tau = 0.01  # Soft target update variable (should be close to 0)
policy_noise = 0.4  # Added noise for exploration
noise_clip = 0.8  # Maximum clamping values of the noise
